...
table.table td .add {
   ...
   <?php 
	    require('../db.php');
	    $results = mysqli_query($con, "SELECT * FROM receipt");
        $result = mysqli_query($con, "SELECT DISTINCT touristOrigin FROM receipt");
   ?>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="../Mainpage.php">New Entry</a></li>
          <li><a href="../Mainpage.php">Activity</a></li>
...
<div class="container-lg">
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <form method = "post">
                <!-- select origin -->
                <select name = "touristOrigin">
                <?php
                while ($rows = $result->fetch_assoc())
                {
                    $touristOrigin = $rows['touristOrigin'];
                    echo "<option value='$touristOrigin'>$touristOrigin</option>";
                }
                ?>
                </select>
                <!-- end select origin -->
                <div align ="right">
                    <input type="submit" name="submit2" value="Generate Report" class="login-button col-sm-3">
                </div>
            </form>
            <!-- end generate report -->
            <!-- show data based on selected region -->
            <?php
            ...
            { 
                ...
                <table class="table table-bordered">
                    ...
                    <?php 
                        ...
                        $results = mysqli_query($con, "SELECT receipt.receiptID, receipt.OrderID, receipt.Name, receipt.numberOfPeople, receipt.dateOfVisit, receipt.amount_paid, receipt.touristOrigin, orders.OrderID, orders.ActivityID, activity.activityID, activity.activityName FROM orders INNER JOIN receipt ON orders.OrderID = receipt.OrderID INNER JOIN activity ON orders.activityID = activity.activityID WHERE touristOrigin = '$touristOrigin'");
                        $bil = 1;
