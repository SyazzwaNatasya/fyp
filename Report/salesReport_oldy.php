    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../Mainpage.php">Profile</a></li>
        </ul>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8 mb-3"><h2>Bombon Marakau Sales History</h2></div>
                </div>
            </div>
            <!-- select date -->
            <form method = "post">
                <div>
                    ...
                    <input type="date" name="dt2" id="dt2">
                    <button onclick="document.getElementById('dt', 'dt2').value = ''">Clear Date</button>
                    <!-- <input type="submit" value="Generate Monthly Report" class="login-button col-sm-3 mb-3"> -->
                    <div align ="right">
                        <input type="submit" name="submit1" value="Generate Report" class="login-button col-sm-3">
                    </div>
                </div>
            </form>
            <!-- end select date -->
            ...
            if(isset($_POST["submit1"]))
            {
                ...
                <table class="table table-bordered">
            	    ...
            	    <tbody>
                    <?php 
                        $results = mysqli_query($con, "SELECT receipt.receiptID, receipt.OrderID, receipt.Name, receipt.numberOfPeople, receipt.dateOfVisit, receipt.amount_paid, receipt.touristOrigin, orders.OrderID, orders.ActivityID, activity.activityID, activity.activityName FROM orders INNER JOIN receipt ON orders.OrderID = receipt.OrderID INNER JOIN activity ON orders.activityID = activity.activityID WHERE (dateOfVisit>='$_POST[dt]' && dateOfVisit<='$_POST[dt2]')");
                        $bil = 1;
